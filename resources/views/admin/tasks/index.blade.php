        ...
        <aside class="sidebar">
            <div class="sidebar-top">
                ...
                <nav class="sidebar-menu">
                    ...
                    <a href="{{ route('admin.tasks.index') }}" class="menu-item active">
        ...
        <main class="main-content">
            ...
            <section class="admin-tasks-layout">
                <div class="recent-tasks-card admin-tasks-card">
                    ...
                    <form method="GET" action="{{ route('admin.tasks.index') }}" class="admin-task-filter">
                        ...
                        <div class="form-field">
                            ...
                            <select name="status">
                                ...
                                <option value="due-today" @selected($filters['status'] === 'due-today')>Due Today</option>
                        ...
                        <div class="filter-actions">
                            ...
                            <a href="{{ route('admin.tasks.index') }}" class="admin-secondary-btn">
                                Reset
                            </a>
                        </div>
                    </form>
                    ...
                    <div class="admin-task-list">
                        @forelse($tasks as $task)
                            <article class="admin-task-row">
                                ...
                                <div class="task-tags">
                                    <span class="badge status {{ $task['status_class'] }}">
                                        {{ $task['status_label'] }}
                                    </span>
                                ...
                                <details class="admin-task-details">
                                    ...
                                    <div class="admin-task-panel">
                                        <form method="POST" action="{{ route('admin.tasks.update', $task['id']) }}" class="admin-form-block admin-task-form">
                                            @csrf
                                            @method('PATCH')
                                            ...
                                            <div class="admin-form-grid">
                                                <div class="form-field">
                                                    ...
                                                    <select name="user_id" required>
                                                        @foreach($users as $user)
                                                            <option value="{{ $user->id }}" @selected((int) $task['user_id'] === (int) $user->id)>
                                                                {{ $user->full_name ?: $user->name ?: $user->username }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-field">
                                                    ...
                                                    <input type="date" name="deadline" value="{{ $task['deadline_input'] }}">
                                                </div>

                                                <div class="form-field">
                                                    <label>Manual Progress</label>
                                                    <input type="number" name="progress" value="{{ $task['stored_progress'] }}" min="0" max="100">
                                                </div>
                                                ...
                                                <div class="form-field full">
                                                    <label>Tags</label>
                                                    <input type="text" name="tags" value="{{ $task['tags_text'] }}" placeholder="urgent, frontend, revision">
                                                </div>
                                            </div>
                                        ...
                                        <div class="admin-task-actions">
                                            <form method="POST" action="{{ route('admin.tasks.complete', $task['id']) }}" class="admin-complete-form">
                                                @csrf
                                                @method('PATCH')
                ...
                <aside class="deadlines-card admin-create-task-card" id="createTaskForm">
                    <div class="section-header">
                        <h3>Create Task</h3>
                        <p>Create a task and assign it to any user</p>
                    </div>

                    <form method="POST" action="{{ route('admin.tasks.store') }}" class="admin-create-task-form">
                        @csrf
                        ...
                        <div class="form-field">
                            <label>Description</label>
                            <textarea name="description" rows="3" placeholder="Task description">{{ old('description') }}</textarea>
                        </div>
                        ...
                        <div class="form-field">
                            <label>Category</label>
                            <input type="text" name="category" value="{{ old('category') }}" placeholder="Category">
                        </div>
                        ...
                        <div class="form-field">
                            <label>Assignee</label>
                            <input type="text" name="assignee" value="{{ old('assignee') }}" placeholder="Assignee">
                        </div>

                        <div class="form-field">
                            <label>Tags</label>
                            <input type="text" name="tags" value="{{ old('tags') }}" placeholder="urgent, frontend, revision">
                        </div>

                        <button type="submit" class="new-task-btn admin-create-task-btn">
                            Create Task
                        </button>
                    </form>
                </aside>
